import * as utils from '../../designs/index'
...
describe('getRuntimeColors', () => {
  const { getRuntimeColors, setRuntimeColors } = utils

  afterEach(() => {
    setRuntimeColors('cyanColors')
  })

  it('defualt run time color', () => {
    expect(getRuntimeColors).toMatchInlineSnapshot(`[Function]`)
    expect(getRuntimeColors()).toMatchInlineSnapshot(`"cyanColors"`)
  })

  it('blueColors runtime colors', () => {
    setRuntimeColors('blueColors')
    expect(getRuntimeColors()).toMatchInlineSnapshot(`"blueColors"`)
  })

  it('geekBlueColors runtime colors', () => {
    setRuntimeColors('geekBlueColors')
    expect(getRuntimeColors()).toMatchInlineSnapshot(`"geekBlueColors"`)
  })

  it('cyanColors runtime colors', () => {
    setRuntimeColors('cyanColors')
    expect(getRuntimeColors()).toMatchInlineSnapshot(`"cyanColors"`)
  })

  it('goldColors runtime colors', () => {
    setRuntimeColors('goldColors')
    expect(getRuntimeColors()).toMatchInlineSnapshot(`"goldColors"`)
  })
  ...
  it('grayColors runtime colors', () => {
    setRuntimeColors('grayColors')
    expect(getRuntimeColors()).toMatchInlineSnapshot(`"grayColors"`)
  })

  it('greenColors runtime colors', () => {
    setRuntimeColors('greenColors')
    expect(getRuntimeColors()).toMatchInlineSnapshot(`"greenColors"`)
  })

  it('limeColors runtime colors', () => {
    setRuntimeColors('limeColors')
    expect(getRuntimeColors()).toMatchInlineSnapshot(`"limeColors"`)
  })

  it('magentaColors runtime colors', () => {
    setRuntimeColors('magentaColors')
    expect(getRuntimeColors()).toMatchInlineSnapshot(`"magentaColors"`)
  })

  it('orangeColors runtime colors', () => {
    setRuntimeColors('orangeColors')
    expect(getRuntimeColors()).toMatchInlineSnapshot(`"orangeColors"`)
  })

  it('purpleColors runtime colors', () => {
    setRuntimeColors('purpleColors')
    expect(getRuntimeColors()).toMatchInlineSnapshot(`"purpleColors"`)
  })

  it('redColors runtime colors', () => {
    setRuntimeColors('redColors')
    expect(getRuntimeColors()).toMatchInlineSnapshot(`"redColors"`)
  })

  it('volcanoColors runtime colors', () => {
    setRuntimeColors('volcanoColors')
    expect(getRuntimeColors()).toMatchInlineSnapshot(`"volcanoColors"`)
  })

  it('yellowColors runtime colors', () => {
    setRuntimeColors('yellowColors')
    expect(getRuntimeColors()).toMatchInlineSnapshot(`"yellowColors"`)
  })
})
